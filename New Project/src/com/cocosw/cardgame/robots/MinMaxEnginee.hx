...
class MinMaxEnginee 
{
	...
	private var Card[] board;
	private var String[] elements;
	private var int cardOnBoard;
	private var boolean ruleSame, rulePlus, ruleSameWall, ruleCombo, ruleElementary, rulePlusWall;
	
	public function MinMaxEngine(Card[] b, String[] e, boolean identique, boolean plus, boolean mememur, boolean combo, boolean plusWall, boolean elementaire) {
		board = b;
		elements = e;
	...
	public function  playCard(int player, Card card, int cell)
	{	
		board[cell] = card;
		cardOnBoard += 1;
	...
	private function  applySameRule(int player, Card what, int cell, boolean combo)
	{
	...
	private function  applyPlusRule(int player, Card what, int cell, boolean combo) {
		int[] sums = new int[4];
		int[] cells = new int[4];
	...
	private function  applyElementaireRule(Card card, int cell)
	{
